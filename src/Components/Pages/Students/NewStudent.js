...
const [deleteIndex, setDeleteIndex] = useState(null);
  ...
  const handleSaveNewStudent = () => {
    ...
    if (saveStudentId) {
      newStudent.userId = saveStudentId
    }
  ...
  return (
    <Layout>
      <div className="container-fluid new-std-container">
        <h4 className="new-std-head">{saveStudentId ? 'Edit' : 'New'} Student Details</h4>
        <hr />
        <div className="mb-5">
                ...
                <Col lg="4">
                  ...
                  <div>
                    <input
                      type="text"
                      className="std-input-control"
                      value={newStudent?.firstLanguage}
                      onChange={(e) =>
                ...
                <Col lg="4">
                  ...
                  <div>
                    <input
                      ...
                      className="std-input-control"
                      value={
                        newStudent?.passport_expiry_date
                          ? format(new Date(newStudent.passport_expiry_date), "yyyy-MM-dd")
                          : ""
                      }
                      onChange={(e) =>
                ...
                <Col lg="4">
                  ...
                  <div>
                    <Select
                      ...
                      isClearable
                      value={countryOption?.find((li) => li.value === newStudent?.country)}
          ...
          <TabPane tabId={2}>
            <div className="container-fluid">
              <div>
                ...
                <div className="my-5">
                  {
                    newStudent?.qualification?.length > 0 && newStudent?.qualification?.map((detail,indx) => {
                        ...
                        <CardBody>
                          ...
                          <Row>
                            ...
                            <Col md={6}>
                              ...
                              <CardText><strong>User ID:</strong> {newStudent?.studentId}</CardText>
                            </Col>
                          </Row>
          ...
          <TabPane tabId={3}>
            <div className="container-fluid">
              <div>
                ...
                <div className="my-5">
                  {
                    newStudent?.school?.length > 0 && newStudent?.school?.map((detail,indx) => {
                      return <Card className="mb-3 shadow-sm border-0">
                        <CardBody>
                          <CardTitle tag="h5" className="mb-3">
